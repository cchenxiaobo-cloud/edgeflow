...
var ContractEndpoints = []Endpoint{
	...
	{Method: "PATCH", Path: "/api/v1/models/{modelName}/releases/{releaseID}", Note: "发布运行中可调参数（v0.17.0；batchSize/pauseBetween/failFast 部分更新批边界生效；v0.19.0 起白名单扩展 failureBudget=0 即关闸）"},
